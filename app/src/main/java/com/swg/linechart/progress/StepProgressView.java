...
public class StepProgressView extends View {
    ...
    public StepProgressView(Context context, @Nullable AttributeSet attrs) {
        ...
        colors[1] = progressCircleNormalColor;
        positions[0] = 0;
        positions[1] = 1;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            drawLine(canvas, i);
            textPaint.setColor(progressTextDescribeColor);
            canvas.drawText(datas.get(i), stepWidth * i + stepWidth / 2, progressCircleRadius * 2 + progressMarginTop * 2 + progressTextHeight, textPaint);
            textPaint.setColor(progressTextDateColor);
            canvas.drawText(datas.get(i), stepWidth * i + stepWidth / 2, progressCircleRadius * 2 + progressMarginTop * 3 + progressTextHeight * 2, textPaint);
        }
    }
     ...
     * @param step
     */
    public void setDatas(List<String> datas, int step) {
