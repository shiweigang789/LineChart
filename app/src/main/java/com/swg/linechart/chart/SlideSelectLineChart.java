...
import com.swg.linechart.chart.bean.Line;
import com.swg.linechart.chart.bean.PointValue;
import com.swg.linechart.chart.bean.SlidingLine;
import com.swg.linechart.chart.renderer.SlideSelectLineRenderer;
...
public class SlideSelectLineChart extends AbsLeafChart {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (slidingLine != null && slidingLine.isOpenSlideSelect()) {
            //绘制移动标尺线
            if (isDrawMoveLine) {
                slideRenderer.drawSlideLine(canvas, axisX, axisY, slidingLine, moveX, moveY, mYStep);
            }
        }
    }
